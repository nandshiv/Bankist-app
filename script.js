...
const account1 = {
  ...
  movementsDates: [
    ...
    '2025-06-13T17:01:17.194Z',
    '2025-06-14T23:36:17.929Z',
    '2025-06-15T10:51:36.790Z',
  ],
  currency: 'EUR',
  locale: 'pt-PT', // de-DE
};
...
const account2 = {
  ...
  movementsDates: [
    ...
    '2025-06-13T14:43:26.374Z',
    '2025-06-14T18:49:59.371Z',
    '2025-06-15T12:01:20.894Z',
  ],
  currency: 'USD',
  locale: 'en-US',
};
...
const formatMovementtDate = function (date) {
...
const displayMovements = function (acc, sort = false) {
  ...
  combinedMovementsDates.forEach(function (obj, i) {
    ...
    const displayDate = formatMovementtDate(date);
